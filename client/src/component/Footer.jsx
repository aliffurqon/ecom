        ...
        <MDBRow>
          <MDBCol lg='4' md='6' className='mb-4 mb-md-0'>
            ...
            <ul className='list-unstyled mb-0 text-start fw-light'>
              ...
              <li>
                <a href='#!' className='text-light'>F.A.Q TERMS & CONDITIONS</a>
              </li>
              <li>
          ...
          <MDBCol lg='4' md='6' className='mb-4 mb-md-0'>
            ...
            <ul className='list-unstyled text-start fw-light'>
              <li>
                <a href='#!' className='text-light'>HOW TO BUY</a>
              </li>
              <li>
                <a href='#!' className='text-light'>TRANSFER CONFIRMATION</a>
              </li>
              <li>
                <a href='#!' className='text-light'>ORDER TRACKING</a>
              </li>
              <li>
                <a href='#!' className='text-light'>CHECK SHIPPING FEE</a>
              </li>
            </ul>
          </MDBCol>
